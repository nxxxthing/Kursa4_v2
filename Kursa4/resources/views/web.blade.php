...
<body class="page">
  ...
  <div class = "Header">
  <p>Треба поїздка?</p>
      <div class = "headerYelEl"> <a href="#" id = "button" class = "button" style="color:#000000"> <p> Замовити машину</p> </a> </div>
...
<div class="Block Block--grey">
  ...
  <div class = "commentAll"><p class = "commentText">
    ...
    пояснювати з якого боку магазину стою) Ціна хороша за послуги, все подобається, буду користуватися далі.</p>
